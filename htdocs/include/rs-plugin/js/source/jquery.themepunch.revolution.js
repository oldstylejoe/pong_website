		...
		if (extension.check!="stop") {
			...
			if (_R.getversion().core<extension.min_core) {			
				if (extension.check===undefined) {
					...
					console.log("%c"+"     Core is older than expected ("+extension.min_core+") from "+extension.alias,'color:#232023');
					console.log("%c"+"     Please update Slider Revolution to the latest version.",'color:#232023');
					console.log("%c"+"     It might be required to purge and clear Server/Client side Caches.",'color:#232023');
			...
			if (_R.getversion()[extension.name]!=undefined && extension.version <_R.getversion()[extension.name]) {
				if (extension.check===undefined) {
					console.log("%c"+"Slider Revolution Warning (Core:"+_R.getversion().core+")",'color:#c0392b;font-weight:bold;');
					console.log("%c"+"     "+extension.alias+" ("+extension.version+") is older than requiered ("+_R.getversion()[extension.name]+")",'color:#232023');
					console.log("%c"+"     Please update Slider Revolution to the latest version.",'color:#232023');
					console.log("%c"+"     It might be required to purge and clear Server/Client side Caches.",'color:#232023');				
				}
				extension.check="stop";
